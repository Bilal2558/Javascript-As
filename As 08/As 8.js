...
// var character =prompt("Inter character string for uppercase or lower case show");
...
// 2
document.write("<h3>...........2<br> display  larger and equal number<h3>");
// var num1 =prompt("Inter frist number for  display  larger and equal number");
// var num2 =prompt("Inter second number for  display  larger and equal number");
// if (num1 === num2) {
//  alert ('equal number');
// }
// else if  (num1 > num2 ){
...
// const number = parseInt(prompt("Enter a number for check positive negative or zero number"));
