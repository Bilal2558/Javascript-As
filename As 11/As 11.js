...
// 9
document.write("<h4>...........9 converts a string “472” to a number 472. <h4>");
let value = "472";
document.write("<h6> Value: " + value + "<br> Type: " + typeof value ,"<h6>");

var num = Number(value);
document.write("<h6>","Value: " + num+ "<br> Type: " ,typeof num , "</h6>");
